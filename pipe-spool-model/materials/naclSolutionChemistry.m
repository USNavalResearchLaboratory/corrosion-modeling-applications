classdef naclSolutionChemistry
    %polarizationCurveChemistry Summary of this class goes here
    ...
    methods
        function obj = naclSolutionChemistry(cCl,T)
            %polarizationCurveChemistry Constructs an instance of this class
