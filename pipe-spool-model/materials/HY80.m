classdef HY80 < corrodingMetal & handle
    %HY80 Summary of this class goes here
    %   Detailed explanation goes here

    methods

        function obj = HY80(name,ccl,T,pH)
        ...
        function actEnergies = CalculateDeltaG(obj,whichBarrier,ccl,ph,T)
            switch whichBarrier
                case 'ORR'
                    ...
                    %dependence
                    data = readmatrix('HY80ORRCoeffs.csv');
                    p00 = data(1);
                    p10 = data(2);
                    p01 = data(3);
                    p20 = data(4);
                ...
                case 'HER'
                    %Expression to predict dG_cathodic without pH
                    %dependence
                    data = readmatrix('HY80HERCoeffs.csv');
                    p00 = data(1);
                    p10 = data(2);
                    p01 = data(3);
                    p20 = data(4);
                ...
                case 'Oxidation'
                    ...
                    %dependence
                    data = readmatrix('HY80FeOxCoeffs.csv');
                    p00 = data(1);
                    p10 = data(2);
                    p01 = data(3);
                    p20 = data(4);
                ...
                case 'Pitting'
                    %Expression to predict dG_cathodic without pH
                    %dependence
                    data = readmatrix('HY80PitCoeffs.csv');
                    p00 = data(1);
                    p10 = data(2);
                    p01 = data(3);
                    p20 = data(4);
