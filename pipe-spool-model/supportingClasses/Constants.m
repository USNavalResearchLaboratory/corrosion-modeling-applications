classdef Constants
    %Constants = class containing physical constant values.
    %   This class contains variables storing physical constant values for
    %   use in electrochemical calculations.
    %==========================================================================
    ...
    properties (Constant = true)
        ...
        e0_CuNi_ox = 0.2869; %Geometric average of Cu0.7 and Ni0.3, V_SHE
